...
export function Section05() {
  ...
  return (
    <section className="bg-[#581C87] pb-12">
      <div className="mx-4 flex flex-col items-center pt-12 text-center text-white">
        ...
        <button className="mx-auto mb-16 mt-6 flex h-16 w-[306px] items-center rounded-[100px] border-2 border-[#FCD34D] pl-12 text-[24px] font-bold leading-6 text-yellowCusto-0 transition delay-150 duration-300 hover:bg-[#581C87] hover:text-[#FCD34D] hover:delay-150 md:mb-0">
          Request a Quote
      ...
      >
        <SwiperSlide className="ml-4">
          <div className="flex h-[359px] w-[358px] flex-col justify-between rounded-2xl bg-white p-6 shadow-md">
